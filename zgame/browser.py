...
WEB_ENABLE_FOG = True
WEB_FOG_RENDER_SCALE = 0.4 if IS_WEB else 1.0
WEB_FOG_REFRESH_MS = 110 if IS_WEB else 0
WEB_FOG_PLAYER_QUANT = 8 if IS_WEB else 1
WEB_FOG_LANTERN_QUANT = 10 if IS_WEB else 1
...
WEB_HURRICANE_VISUAL_REFRESH_MS = 50 if IS_WEB else 0
