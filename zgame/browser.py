...
WEB_ENABLE_FOG = True
WEB_FOG_RENDER_SCALE = 0.33 if IS_WEB else 1.0
WEB_FOG_REFRESH_MS = 220 if IS_WEB else 0
WEB_FOG_PLAYER_QUANT = 10 if IS_WEB else 1
WEB_FOG_LANTERN_QUANT = 12 if IS_WEB else 1
WEB_FOG_PULSE_QUANT = 5 if IS_WEB else 1
WEB_FOG_CAMERA_QUANT = 48 if IS_WEB else 1
WEB_FOG_MAX_LANTERNS = 10 if IS_WEB else 0
WEB_FOG_OVERLAY_ALPHA = 58 if IS_WEB else 0
