...
from zgame.browser import (
    ...
    WEB_AUTOSTART,
    WEB_DIAG_DURATION_S,
    WEB_DIAG_FORCE_BIOME,
    WEB_DIAG_FORCE_LEVEL,
    WEB_DIAG_FORCE_TRANSITION,
    WEB_DIAG_FORCE_ULTIMATE,
    WEB_DIAG_MODE,
    WEB_DIAG_SCENARIO,
    WEB_DIAG_TAG,
    ...
    WEB_RENDER_INTERVAL,
    WEB_SINGLE_BGM,
    WEB_SIMPLE_ENEMY_FULL_MOVE_RADIUS_CELLS,
